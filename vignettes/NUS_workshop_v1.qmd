...
norm = plot_marker_densities(data_sce, sample_id_col = "metabricId", markers_to_plot = "CD3", assay_name = "norm")$CD3 + theme(legend.position = "none") + ggtitle("")
log = plot_marker_densities(data_sce, sample_id_col = "metabricId", markers_to_plot = c("CD3"), assay_name = "logcounts")$CD3 + theme(legend.position = "none") + ggtitle("")
