...
# Load data
load("../2025_CUHK/data/breastCancer.RData")
data_sce = IMC
...
```{r, warning=FALSE, error=FALSE, message=FALSE}
coexp_df <- readRDS("../2025_CUHK/data/coexp_df.rds")
...
scfeatures_result <- readRDS("../2025_CUHK/data/scfeatures_result.RDS")
...
```{r, warning=FALSE, error=FALSE, message=FALSE}
classifyr_result_IMC <- readRDS("../2025_CUHK/data/classifyr_result_IMC.rds")
```
...
```{r, warning=FALSE, error=FALSE, message=FALSE}
survForestCV <- readRDS("../2025_CUHK/data/survForestCV.RDS")
```
